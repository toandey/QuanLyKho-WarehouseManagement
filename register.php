        ...
        <div class="wrapper">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <select class="form-select" aria-label="Default select example">
                    <option selected>Vui lòng lựa chọn vai trò!</option>
                ...
                <div style="text-align: center;  margin-top: 10px;">Đã có tài khoản? Đăng nhập <a href="login.php">tại đây</a>.</div>
                <div>
                    ---------------
                    <br>
                    LƯU Ý: HỆ THỐNG ĐANG TRONG QUÁ TRÌNH THỬ NGHIỆM NÊN TÀI KHOẢN SẼ ĐƯỢC GÁN MẶC ĐỊNH VAI TRÒ THỦ KHO VÀ KHÔNG CẦN PHÊ DUYỆT!
                </div>
            </form>
        </div>     
    </div>
