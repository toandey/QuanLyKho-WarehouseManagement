...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($masanpham)){
        $masanpham_err = "Trường này là bắt buộc.";
    } else {
        $masanpham = $masanpham;
    }
    ...
    if(empty($tensanpham)){
        $tensanpham_err = "Trường này là bắt buộc.";
    } else {
    ...
    if(empty($gianhap)){
        $gianhap_err = "Trường này là bắt buộc.";
    } else {
        $gianhap = $gianhap;
    }
    ...
    if(empty($giaban)){
        $giaban_err = "Trường này là bắt buộc.";
    } else {
        $giaban = $giaban;
    }
    ...
    if(empty($tonkho)){
        $tonkho_err = "Trường này là bắt buộc.";
    } else {
        $tonkho = $tonkho;
    }
