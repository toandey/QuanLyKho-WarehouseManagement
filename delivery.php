...
<head>
    ...
    <title>Phiếu Xuât Hàng - Hệ Thống Quản Lý Kho</title>
    ...
    <div class="container">
      ...
      <div class="phieuxuat">
        <div class="tao-phieu-xuat">
            <h4 style="text-align: center;">Phiếu Xuất Hàng</h4>
            <div style="text-align: center;">Số:..............</div>
            <div style="text-align: center;">Ngày:..............</div>
            <p></p>
            <div>Bên Xuất: Công Ty Cổ phần ToanCorp.</div>
            <div>Địa chỉ: 39 - Nguyễn Trãi - Thanh Xuân - Hà Nội.</div>
            <div>SĐT: 0988989898.</div>
            <div>Mã Số Thuế: 018898989.</div>
            <p>------------------------</p>
            <label>Bên Nhận Hàng</label><br>
            <div class="input">
                <input id="input-text" type="text" placeholder="Bên Nhận Hàng">

            </div>
            <label>Địa Chỉ</label><br>
            <div class="input">
                <input id="input-text" type="text" placeholder="Địa Chỉ">
            </div>
            <label>Số Điện Thoại</label><br>
            <div class="input">
                <input id="input-text" type="text" placeholder="Số Điện Thoại">
            </div>
            <label>Lựa chọn sản phẩm</label><br>
            <div class="input">
                <input id="input-text" type="text" placeholder="Lựa chọn sản phẩm">
            </div>
            <input id="input-text1" type="text" placeholder="Số Lượng">
            <input id="input-text1" type="text" placeholder="Đơn Giá">
            <button id="button">Thành Tiền</button>
        </div>
        <div class="button1">
