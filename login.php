                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "Bạn đã nhập sai username hoặc mật khẩu. Vui lòng nhập lại!";
                        }
                    }
                } else{
...
<body>
    ...
    <?php 
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div id="form-login">
                <h1 id="h1-header"><b>ĐĂNG NHẬP VÀO HỆ THỐNG</b></h1>
                ...
                <div style="text-align: right; padding-bottom: 10px;"><i>Quên mật khẩu?</i></div>
